...
const productData = [
 ...
 
  {
    id: "1",
    images: [
      "https://ik.imagekit.io/jap5d6wbb/image/fernando-andrade-nAOZCYcLND8-unsplash.jpg?updatedAt=1748280009309",
      "https://ik.imagekit.io/mani2/image/pinaapple2.png?updatedAt=1750789578528",
      "https://ik.imagekit.io/mani2/image/vino-li-OKT6Ce9fwqI-unsplash1213.png?updatedAt=1750789591471"
    ],
...

  {
    id: "2",
    images: [
      "https://ik.imagekit.io/mani2/image/hal-gatewood-NaJ3s9y7GGE-unsplash.jpg_updatedAt=1748280060544?updatedAt=1748703724321",
      "https://ik.imagekit.io/mani2/image/pd45batch10-086b-gloy1234.png?updatedAt=1750790694126",
      "https://ik.imagekit.io/mani2/image/sb12.png?updatedAt=1750790653659"
    ],
    title: "Strawberry",
    price: "$179",
    rating: "4.8",
  ...
  },
  {
    ...
    images: [
      ...
      "https://ik.imagekit.io/jap5d6wbb/image/mockup-graphics-haSJEJYzl5A-unsplash-removebg-preview.png?updatedAt=1748806611906",
      "https://ik.imagekit.io/mani2/image/pdwatercolorfruitbatch1-1098-gloy-b123.png?updatedAt=1750791650644",
      "https://ik.imagekit.io/mani2/image/yellow-pear.png?updatedAt=1750791655631"],
  ...
  {
    id: "5",
    images: ["https://ik.imagekit.io/mani2/image/delicious-papaya123.png?updatedAt=1750869129912",
      "https://ik.imagekit.io/mani2/image/close-up-delicious-papaya-table123.png?updatedAt=1750869019174",
      "https://ik.imagekit.io/mani2/image/hepaya.png?updatedAt=1750870324033"],
    title: "Papaya",
    price: "$49",
    rating: "4.8",
    offer: "25",
  ...
  },
  {
    ...
    images: [
      ...
      "https://ik.imagekit.io/mani2/image/cantaloupe-melon1212.png?updatedAt=1750871922672"
  ...
  },
  {
    ...
    images:
      ["https://ik.imagekit.io/mani2/image/orang123.png?updatedAt=1750870788443",
        ...
        "https://ik.imagekit.io/jap5d6wbb/image/mae-mu-U1iYwZ8Dx7k-unsplash.jpg?updatedAt=1748279989900"
      ],
...
const vegetableData = [
  ...
  {
    id: "v2",
    images: ["https://ik.imagekit.io/jap5d6wbb/image/fresh-red-tomatoes121.png?updatedAt=1749059290648",
...
const ProductCard = ({ id, image, images, title, price, rating, offer, total_no_user }) => {
  ...
  const getEncouragingBadges = () => {
    const badges = [];
    if (ratingNum >= 4.8) {
      badges.push({ text: "🔥 HOT SELLER", color: "bg-red-500" });
    }
    return badges;
  };
        ...
        {CategoryButton.map((category) => (
          <div key={category.id} className="flex flex-col items-center cursor-pointer" onClick={() => setActCategory(category.id)}>
            <img
              src={category.img}
              alt={category.label}
              className={`w-24 h-24 object-cover rounded-full border-4 transition-all duration-300 ${actCategory === category.id ? 'border-blue-600 shadow-lg scale-110' : 'border-gray-200'}`}
            />
            <span className={`mt-2 text-lg font-semibold ${actCategory === category.id ? 'text-blue-600' : 'text-gray-700'}`}>{category.label}</span>
          </div>
        ))}
      </div>
